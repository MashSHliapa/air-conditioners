...
import photo from '.././../images/condition.png';
import './Catalog.scss';
            ...
            <div className="catalog__cards">
              <div className="catalog__card card">
                <div className="card__body">
                  ...
                  <div className="card__title">MDV Forest Inverter MDSAF-09HRDN8</div>
                  <div className="card__price">1 690 BYN</div>
                </div>
                <div className="card__button-favorite">
                  <div className="card__button-wrapper _button-wrapper">
                    <div className="card__button _button">ПОДРОБНЕЕ</div>
                  </div>
